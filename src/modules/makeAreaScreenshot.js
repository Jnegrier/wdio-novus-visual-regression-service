...
const log = logger('wdio-novus-mutatio-visual-regression-service:makeAreaScreenshot');
...
export default async function makeAreaScreenshot(browser, startX, startY, endX, endY) {
  log.info('requested a screenshot for the following area: %j', { startX, startY, endX, endY });
